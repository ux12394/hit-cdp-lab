...
--               e:/COLLEGE/homework/hit-cdp-lab/lab3_ram/lab3_ram.gen/sources_1/ip/regfile_0/regfile_0_sim_netlist.vhdl
-- Design      : regfile_0
...
entity regfile_0_regfile is
  ...
  attribute ORIG_REF_NAME of regfile_0_regfile : entity is "regfile";
end regfile_0_regfile;

architecture STRUCTURE of regfile_0_regfile is
...
entity regfile_0 is
  ...
  attribute NotValidForBitStream of regfile_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of regfile_0 : entity is "regfile_0,regfile,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of regfile_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of regfile_0 : entity is "package_project";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of regfile_0 : entity is "regfile,Vivado 2024.1";
end regfile_0;

architecture STRUCTURE of regfile_0 is
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of clk : signal is "xilinx.com:signal:clock:1.0 clk CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, INSERT_VIP 0";
begin
inst: entity work.regfile_0_regfile
     port map (
      clk => clk,
