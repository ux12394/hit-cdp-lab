...
#
# Script generated by Vivado on Sun Sep 01 14:25:13 +0800 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : regfile_0.sh
...
#
# Usage        : regfile_0.sh
#                regfile_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                regfile_0.sh [-reset_run]
#                regfile_0.sh [-reset_log]
#                regfile_0.sh [-help]
#
...
# script info
echo -e "regfile_0.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./regfile_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot regfile_0 xil_defaultlib.regfile_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim regfile_0 -key {Behavioral:sim_1:Functional:regfile_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb regfile_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./regfile_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: regfile_0.sh [-help]\n\
Usage: regfile_0.sh [-step]\n\
Usage: regfile_0.sh [-lib_map_path]\n\
Usage: regfile_0.sh [-reset_run]\n\
Usage: regfile_0.sh [-reset_log]\n\
Usage: regfile_0.sh [-keep_index]\n\
Usage: regfile_0.sh [-noclean_files]\n\n\
