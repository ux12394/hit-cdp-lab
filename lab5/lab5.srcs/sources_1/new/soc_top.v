/*
 * @Author: S.H.Y 
 * @Date: 2024-09-09 23:04:01 
 * @Last Modified by:   S.H.Y 
 * @Last Modified time: 2024-09-09 23:04:01 
 */
`timescale 1ns / 1ps
...
(
    ...
    cpu_checker #(.SIMULATION(SIMULATION)) checker(
        .clk(clk),
        .resetn(resetn),
