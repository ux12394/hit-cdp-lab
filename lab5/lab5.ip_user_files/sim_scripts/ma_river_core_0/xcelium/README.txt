...
#
# Generated by export_simulation on Tue Aug 20 19:20:24 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './ma_river_core_0.sh' script.

./ma_river_core_0.sh -reset_run
...
./ma_river_core_0.sh -noclean_files

For more information on the script, please type './ma_river_core_0.sh -help'.
