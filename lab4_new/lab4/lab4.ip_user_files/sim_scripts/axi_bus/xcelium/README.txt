...
#
# Generated by export_simulation on Tue Aug 20 19:34:35 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './axi_bus.sh' script.

./axi_bus.sh -reset_run
...
./axi_bus.sh -noclean_files

For more information on the script, please type './axi_bus.sh -help'.
