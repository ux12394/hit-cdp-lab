...
#
# Generated by export_simulation on Tue Aug 20 20:00:22 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './lcd_controller_0.sh' script.

./lcd_controller_0.sh -reset_run
...
./lcd_controller_0.sh -noclean_files

For more information on the script, please type './lcd_controller_0.sh -help'.
