...
#
# Script generated by Vivado on Mon Sep 02 15:13:03 +0800 2024
...
#
# Usage        : add32_0.sh
#                add32_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                add32_0.sh [-reset_run]
#                add32_0.sh [-reset_log]
#                add32_0.sh [-help]
#
...
#                script (type 'add32_0.sh -help' for more information).
#
...
# script info
echo -e "add32_0.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./add32_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../lab4.gen/sources_1/ip/add32_0_1/src" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../lab4.gen/sources_1/ip/add32_0_1/src" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.add32_0 xil_defaultlib.glbl -o add32_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./add32_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key add32_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc add32_0_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./add32_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: add32_0.sh [-help]\n\
Usage: add32_0.sh [-step]\n\
Usage: add32_0.sh [-lib_map_path]\n\
Usage: add32_0.sh [-reset_run]\n\
Usage: add32_0.sh [-reset_log]\n\
Usage: add32_0.sh [-keep_index]\n\
Usage: add32_0.sh [-noclean_files]\n\n\
