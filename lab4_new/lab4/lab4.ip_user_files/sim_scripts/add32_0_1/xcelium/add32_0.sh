...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../lab4.gen/sources_1/ip/add32_0_1/src" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../lab4.gen/sources_1/ip/add32_0_1/src" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.add32_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.add32_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log add32_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
